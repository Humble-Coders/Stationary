        ...
        Box(
            ...
            if (historyOrders.isEmpty()) {
                ...
                LazyColumn(
                    ...
                    item {
                        SummaryCard(
                            totalOrders = historyOrders.size
                        )
                    }
...
private fun SummaryCard(
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = if (totalOrders == 1) "completed order" else "completed orders",
                fontSize = 14.sp,
                color = Color.White.copy(alpha = 0.9f)
            )
        }
        ...
        Column(
            ...
            Row(
                ...
                Row(
                    ...
                    Column {
                        ...
                        Text(
                            text = formatFullDate(order.createdAt.toDate()),
                            fontSize = 12.sp,
                            color = TextSecondary
                        )
                    }
            ...
            Row(
                ...
                InfoChip(
                    ...
                    text = "${getDocumentCount(order)} ${if (getDocumentCount(order) == 1) "file" else "files"}",
                    modifier = Modifier.weight(1f)
                )
            }
...
private fun EmptyHistoryView() {
    Box(
        ...
        Column(
            ...
            Text(
                text = "Your completed print orders\nwill appear here",
                fontSize = 14.sp,
                color = TextSecondary,
